    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GAON-light"), QVariant("light"));
    ui->theme->addItem(QString("GAON-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GAON-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GAON-traditional"), QVariant("trad"));
