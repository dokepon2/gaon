    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Gaon Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gaon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gaon: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Gaon Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gaon Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gaon Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gaon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gaon addresses"));
    ...
    openAction->setStatusTip(tr("Open a gaon: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gaon Core help message to get a list with possible Gaon Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Gaon Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gaon network", "", count));
}
...
{
    QString strTitle = tr("Gaon Core"); // default title
