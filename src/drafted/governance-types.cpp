...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GaonNetwork") type = GaonNetwork;
    if(strType == "GaonNetworkVariable") type = GaonNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GaonNetwork) s = "GaonNetwork";
    if(type == GaonNetworkVariable) s = "GaonNetworkVariable";
