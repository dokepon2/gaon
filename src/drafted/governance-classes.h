 ...
 *
 *   // network
 *   CGaonNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.gaon.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGaonNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: GaonNetwork
// //   -- signature requirements : Key1(User)
// class CGaonNetworkVariable : public CGovernanceObject
// {
// private:
