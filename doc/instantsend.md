...
This mechanism has been integrated into Bitcore-Node-Gaon which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gaoncoin/insight-api-gaon#web-socket-api](https://github.com/gaoncoin/insight-api-gaon#web-socket-api) 
* API: [https://github.com/gaoncoin/insight-api-gaon#instantsend-transactions](https://github.com/gaoncoin/insight-api-gaon#instantsend-transactions) 
...
By default, the Gaon Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gaon Core daemon:
