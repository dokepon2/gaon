...
Only requiring some minor changes is gaon.cpp.
...
Changes to gaon.cpp
----------------------
gaon.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
