...
Gaon Core version 0.12.0 is now available from:

  https://gaoncoin.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/gaoncoin/gaon/issues
...
backwards-compatible with pre-0.12 versions of Gaon Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/gaon/).
